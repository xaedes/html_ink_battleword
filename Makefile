...
STORY_FILES = $(MAIN_STORY_FILE) whack_a_mole.ink fight_a_knight.ink at_seymours_place.ink dreams.ink scratch_post.ink common_functions.ink functions.ink book_of_butterflies.ink
